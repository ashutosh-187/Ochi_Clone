...
export default function Footer() {
    return (
        <div className='flex w-full h-screen bg-zinc-950 px-20 py-16'>

            <div className='relative w-1/2 h-full font-["Lucida Sans Typewriter"] text-9xl font-semibold'>
                <div className='Headings absolute tracking-tighter'>
                    <h1>EYE-</h1>
                    <h1>OPENING</h1>
                    <div className='Logo absolute top-[280%]'>
            ...
            <div className='relative w-1/2 h-full font-["Lucida Sans Typewriter"] text-white'>
                <h1 className='Headings absolute font-["Lucida Sans Typewriter"] text-9xl font-semibold tracking-tighter text-white'>
                    PRESENTATIONS
                </h1>
