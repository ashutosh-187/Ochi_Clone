...
function Navbar() {
    ...
    return (
        <div className={`fixed z-[999] w-full px-20 py-8 font-["Neue_Montreal"] flex items-center justify-between transition-transform duration-300 ${showNavbar ? 'transform translate-y-0' : 'transform -translate-y-full'}`}>
            <div className='logo'>
